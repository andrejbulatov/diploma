...
class ButtonFilterMobile extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Button color="danger" style={{marginRight:'20px'}} onClick={this.toggle}>Фильтр списка</Button>
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          <ModalHeader toggle={this.toggle}>Результат: <b>{listLength}</b></ModalHeader>
          <ModalBody>
            <h4>Категории</h4>
            ...
            <h4>Размер</h4>
              ...
              />
            <h4>Цена {`< ${reducerPriceRangeFilter}₸`}</h4>    
